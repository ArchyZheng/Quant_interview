...
def main():
    ...
    dataset = TradingDataset(data_source=data_source, data_filename=data_name, metadata=config['metadata'])
    ...
    # model part:
    model = BaseGRUModel(input_size=5, hidden_size=30, num_layers=3, with_attention=False)
